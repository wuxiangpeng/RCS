...
package com.cmcc.rcs.utils;


import java.io.IOException;

import com.cmcc.rcs.platform.network.DatagramConnection;
...
public class NetworkRessourceManager {
     ...
     */
    public static final int DEFAULT_LOCAL_SIP_PORT_BASE = 5220;

    /**
     * Default RTP port base
     */
    public static final int DEFAULT_LOCAL_RTP_PORT_BASE = 5220;

    /**
     * Default MSRP port base
     */
    public static final int DEFAULT_LOCAL_MSRP_PORT_BASE = 5220;
