...
public class TCPMessageProcessor extends MessageProcessor {
    private static final String TAG = "TCPMessageProcessor";
     ...
     */
    protected TCPMessageProcessor(InetAddress ipAddress, CPMTransactionStack sipStack, int port) {
    ...
    public void run() {
        ...
        while (this.isRunning) {
            try {
                ...
                Log.i(TAG, "Accepting new connection!");
    ...
    protected synchronized void remove(TCPMessageChannel tcpMessageChannel) {
        ...
        Log.i(TAG, Thread.currentThread() + " removing " + key);
    ...
    protected synchronized void cacheMessageChannel(TCPMessageChannel messageChannel) {
        ...
        if (currentChannel != null) {           
            Log.i(TAG, "Closing " + key);
            currentChannel.close();
        }
       
        Log.i(TAG, "Caching " + key);
