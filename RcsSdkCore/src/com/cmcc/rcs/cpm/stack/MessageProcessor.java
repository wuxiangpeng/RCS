...
import com.cmcc.rcs.cpm.ListeningPointImpl;
...
public abstract class MessageProcessor implements Runnable {
    ...
    protected MessageProcessor( InetAddress ipAddress, int port, String transport,
    							CPMTransactionStack transactionStack ) {
    	this( transport );
    ...
    public ListeningPointImpl getListeningPoint() {
        ...
        if ( listeningPoint == null )  {           
            Log.i(TAG, "getListeningPoint" + this +
    ...
    public void setListeningPoint(ListeningPointImpl lp) {        
        Log.i(TAG, "setListeningPoint" + this +
                    " listeningPoint = " + lp);
        
        if ( lp.getPort() != this.getPort() ) {
            throw new RuntimeException("lp mismatch with provider");
        }
