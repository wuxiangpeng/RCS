...
import com.cmcc.rcs.cpm.ClientTransaction;
import com.cmcc.rcs.cpm.core.api.address.Address;
import com.cmcc.rcs.cpm.core.api.address.URI;
import com.cmcc.rcs.cpm.core.api.header.AcceptHeader;
...
import com.cmcc.rcs.cpm.core.api.header.EventHeader;
...
import com.cmcc.rcs.cpm.core.api.header.ReasonHeader;
import com.cmcc.rcs.cpm.core.api.header.ReferToHeader;
import com.cmcc.rcs.cpm.core.api.header.RequireHeader;
import com.cmcc.rcs.cpm.core.api.header.RouteHeader;
import com.cmcc.rcs.cpm.core.api.header.SIPIfMatchHeader;
import com.cmcc.rcs.cpm.core.api.header.SupportedHeader;
...
public class SipMessageFactory {
	 ...
	 * @throws SipException
	 */
//    public static SipRequest createRegister(CPMData dialog, String[] featureTags, int expirePeriod, String instanceId) throws SipException {
//		try {
...
//    }    
	 ...
	 * @throws SipException
	 */
//    public static SipRequest createSubscribe(CPMData cpmdata, int expirePeriod) throws SipException {
//		try {
//	        // Set request line header
//	        URI requestURI = SipUtils.ADDR_FACTORY.createURI(dialog.getTarget());
//	        
...
//    }	
	 ...
	 * @throws SipException
	 */
	public static SipRequest createMessage(CPMData cpmdata, String contentType, String content) throws SipException {
		return createMessage(cpmdata, null, contentType, content);
	}
	 ...
	 * @throws SipException
	 */
	public static SipRequest createMessage(CPMData dialog, String featureTag, String content, String contentType) throws SipException {
		try {			
	        // Set request line header
	        URI requestURI = SipUtils.ADDR_FACTORY.createURI(dialog.getToAddress());
	
	        // Set Call-Id header
	        CallIdHeader callIdHeader = SipUtils.HEADER_FACTORY.createCallIdHeader(dialog.createOrobtainCallId()); 
	        
	        // Set the CSeq header
	        CSeqHeader cseqHeader = SipUtils.HEADER_FACTORY.createCSeqHeader(dialog.getCseq(), Request.MESSAGE);
	        
	        // Set the From header
	        Address fromAddress = SipUtils.ADDR_FACTORY.createAddress(dialog.getFromAddress());
	        FromHeader fromHeader = SipUtils.HEADER_FACTORY.createFromHeader(fromAddress, dialog.getLocalTag());
	
	        // Set the To header
	        Address toAddress = SipUtils.ADDR_FACTORY.createAddress(dialog.getToAddress());
	        ToHeader toHeader = SipUtils.HEADER_FACTORY.createToHeader(toAddress, dialog.getRemoteTag());
...
//            SipUtils.setRemoteInstanceID(message, dialog.getRemoteSipInstance());
	 ...
	 * @throws SipException
	 */
//    public static SipRequest createPublish(CPMData dialog,
//    		int expirePeriod,
//    		String entityTag,
...
//    }	
     ...
     * @throws SipException
     */
//    public static SipRequest createInvite(CPMData cpmdata,	String[] featureTags, String sdp) throws SipException {
//        return createInvite(cpmdata, featureTags, featureTags, sdp);
//    }
     ...
     * @throws SipException
     */
//    public static SipRequest createInvite(CPMData dialog,	String[] featureTags, String[] acceptTags, String sdp) throws SipException {
//		try {
...
//    }
     ...
     * @throws SipException
     */
//    public static SipRequest createMultipartInvite(CPMData dialog,
//    		String[] featureTags,
//			String multipart,
//			String boundary)
//            throws SipException {
...
//    }
     ...
     * @throws SipException
     */
//    public static SipRequest createInvite(CPMData dialog,
//    		String[] featureTags,
//			String content,
...
//    }
     ...
     * @throws SipException
     */
//    public static SipRequest createInvite(CPMData dialog,	String[] featureTags, String sdp, String prefServiceHeaderVal) throws SipException {
//		try {
...
//    }
     ...
     * @throws SipException
     */
//    public static SipResponse create200OkInviteResponse(CPMData dialog, String[] featureTags, String sdp) throws SipException {
...
//    }
	 ...
	 * @throws SipException
	 */
//	public static SipResponse create200OkInviteResponse(CPMData dialog, String[] featureTags, String[] acceptContactTags, String sdp) throws SipException {
//		try {
//			// Create the response
...
//	}
	 ...
	 * @throws SipException
	 */
//	public static SipRequest createAck(CPMData dialog) throws SipException {
//        try {
//            Request ack = null;
//
//            // Set request line header
...
//	}
	 ...
	 * @throws SipException
	 */
//	public static SipRequest createBye(CPMData dialog) throws SipException {
//		try {
//			// Create the request
...
//	}
	 ...
	 * @throws SipException
	 */
//	public static SipRequest createCancel(CPMData dialog) throws SipException {
//		try {
//	        // Create the request
...
//	}
	 ...
	 * @throws SipException
	 */
//    public static SipRequest createOptions(CPMData dialog, String[] featureTags) throws SipException {
//		try {
//	        // Set request line header
//	        URI requestURI = SipUtils.ADDR_FACTORY.createURI(dialog.getTarget());
//	        
...
//	}
	 ...
	 * @throws SipException
	 */
//    public static SipRequest createRefer(CPMData dialog, String toContact, String subject, String contributionId) throws SipException {
//		try {			
//			// Create the request
...
//    }
	 ...
	 * @throws SipException
	 */
//    public static SipRequest createRefer(CPMData dialog, List<String> participants, String subject, String contributionId) throws SipException {
//    	try {
//			// Create the request
//		    Request refer = dialog.getStackDialog().createRequest(Request.REFER);
//		    
...
//    }
     ...
     * @throws SipException
     */
//    public static SipRequest createReInvite(CPMData dialog) throws SipException {
//        try {
//            // Build the request
...
//    }
     ...
     * @throws SipException
     */
//    public static SipRequest createReInvite(CPMData dialog, String[] featureTags, String content) throws SipException {
//    	try {
//            // Build the request
//    		Request reInvite = dialog.getStackDialog().createRequest(Request.INVITE);          
//            SipRequest firstInvite = dialog.getInvite();
...
//    }
     ...
     * @throws SipException
     */
//    public static SipResponse create200OkReInviteResponse(CPMData dialog, SipRequest request) throws SipException {
//        try {
//            // Create the response
...
//    }
     ...
     * @throws SipException
     */
//    public static SipResponse create200OkReInviteResponse(CPMData dialog, SipRequest request, String[] featureTags, String content) throws SipException{
//    	try {
//			// Create the response
//			Response response = SipUtils.MSG_FACTORY.createResponse(200, (Request)request.getStackMessage());
//	
...
//    }
     ...
     * @throws SipException
     */
//    public static SipRequest createUpdate(CPMData dialog) throws SipException {
//		try {
//			// Create the request
...
//    }
	 ...
	 * @throws SipException
	 */
//	public static SipResponse create200OkUpdateResponse(CPMData dialog, SipRequest request) throws SipException {
//		try {
//			// Create the response
//			Response response = SipUtils.MSG_FACTORY.createResponse(200, (Request)request.getStackMessage());
//			
