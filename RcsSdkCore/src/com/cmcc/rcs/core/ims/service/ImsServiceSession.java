...
import com.cmcc.rcs.cpm.CPMException;
import com.cmcc.rcs.cpm.core.api.SessionAuthenticationAgent;
import com.cmcc.rcs.cpm.core.api.SessionTimerManager;
import com.cmcc.rcs.cpm.core.api.SipManager;
import com.cmcc.rcs.cpm.core.api.SipMessageFactory;
import com.cmcc.rcs.cpm.core.api.SipRequest;
import com.cmcc.rcs.cpm.core.api.SipResponse;
import com.cmcc.rcs.cpm.core.api.SipTransactionContext;
import com.cmcc.rcs.cpm.core.api.SipUtils;
...
public abstract class ImsServiceSession extends Thread {
     ...
     * @throws CPMException
     */
    public abstract SipRequest createInvite() throws CPMException;
     ...
     * @throws CPMException
     */
    public void sendInvite(SipRequest invite) throws CPMException {
        // Send INVITE request
