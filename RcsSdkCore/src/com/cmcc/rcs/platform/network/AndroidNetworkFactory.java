...
import com.cmcc.rcs.core.ims.network.ImsNetworkInterface.DnsResolvedFields;
...
public class AndroidNetworkFactory extends NetworkFactory {
    private static final String TAG = "AndroidNetworkFactory";
    ...
    public String getLocalIpAddress(DnsResolvedFields dnsEntry, int type) {
        ...
        try {
            ...
            Log.e(TAG, "getLocalIpAddress failed with ", e);
        }
        return ipAddress;
    }
